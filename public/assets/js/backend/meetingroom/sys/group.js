define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'jstree'], function ($, undefined, Backend, Table, Form, undefined) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    "index_url": "meetingroom/sys/group/index",
                    "add_url": "meetingroom/sys/group/add",
                    "edit_url": "meetingroom/sys/group/edit",
                    "del_url": "meetingroom/sys/group/del",
                    "multi_url": "meetingroom/sys/group/multi",
                }
            });
        ...
        api: {
            bindevent: function () {
                ...
                $(document).on("change", "select[name='row[pid]']", function () {
                    ...
                    $.ajax({
                        url: "meetingroom/sys/group/roletree",
                        type: 'post',
                        dataType: 'json',
