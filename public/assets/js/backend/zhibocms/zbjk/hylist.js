            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'channel.id', title: __('频道ID')},
                        {field: 'webexinfo.webex.webex_website', title: __('webex站点')},
                        {field: 'webexinfo.webex.webex_name', title: __('webex账号')},
                        {field: 'webexinfo.webex.webex_password', title: __('webex密码')},
                        ...
                        {field: 'channel.play_url', title: __('播放地址')},
                        {field: 'channel.pushurl', title: __('推流地址')},
                        {field: 'join_url', title: __('加入链接')},
                        {field: 'host_url', title: __('主持人链接')},
                        {field: 'hostkey', title: __('主持人秘钥')},
                        {
                            field: 'operate',
                            title: __('Operate'), 
                            table: table, 
